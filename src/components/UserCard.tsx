...
function UserCard(props: { class?: string; children?: JSX.Element }) {
  const { query, fetch } = User.useQuery();
  ...
  return (
    ...
    >
      <div
        class={twMerge(
          'relative max-w-md mx-auto md:max-w-2xl mt-6 min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded-xl mt-16 px-6',
          props.class,
        )}
      >
        {props.children}
